...
Formatting plot attributes: plot style
...
plot(x = chicks.diet1$Time, y = chicks.diet1$weight, col=chicks.diet1$Chick, pch=19)

chicks.diet2 <- subset(ChickWeight, ChickWeight$Diet==2)
points(x = chicks.diet2$Time, y = chicks.diet2$weight, col=chicks.diet2$Chick, pch = 8)
...
plot(x = Orange$age, y = Orange$circumference, 
     col = tree.colors[Orange$Tree], pch = 19)
legend("topleft", 
       legend = levels(Orange$Tree), 
       pch = rep(19,nlevels(Orange$Tree)), 
       col = tree.colors,
